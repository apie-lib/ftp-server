...
class EpsvCommandTest extends TestCase
{
    ...
    public function testEpasvCommand(): void
    {
        ...
        $transfer->end();
        $this->assertEquals("229 Entering Extended Passive Mode (|||6666|)\r\n", $connection->getData());
        Loop::get()->run();
    }
